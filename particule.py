...
class Particule(object):
    ...
    def plot_X_with_time(self, time):
        from pylab import plot
        X=[]
        Y=[]
        for p in self.position:
        ...
        return plot(time,X,color=self.color,label=self.name)+plot(X[-1],Y[-1],'o',color=self.color)

    def plot_Y_with_time(self, time):
        from pylab import plot
        X=[]
        Y=[]
        for p in self.position:
        ...
        return plot(time,Y,color=self.color,label=self.name)+plot(X[-1],Y[-1],'o',color=self.color)    
